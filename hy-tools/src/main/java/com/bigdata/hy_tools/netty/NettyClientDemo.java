...
/** @Author huyi @Date 2021/4/12 11:16 @Description: */
public class NettyClientDemo {
  public static void main(String[] args) {
    ...
    try {
      ...
      // 发起异步连接操作
      ChannelFuture futrue = bootstrap.connect(new InetSocketAddress("127.0.0.1", 18080)).sync();
      for (int i = 0; i < 100; i++) {
        futrue.channel().write("hahahah");
      }
      // 等待客户端链路关闭
