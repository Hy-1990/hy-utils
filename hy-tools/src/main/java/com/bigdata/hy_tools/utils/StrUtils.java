...
public class StrUtils {
  ...
  public static String comma_del(String commaexpress, String delelement) {
    if ((commaexpress == null)
        || (delelement == null)
        || (commaexpress.trim().equals(delelement.trim()))) {
      return "";
    }
  ...
  public static String comma_insert(String commaexpress, String newelement, int index) {
    ...
    String result =
        commaexpress.substring(0, index)
            + newelement
  ...
  /**
   * 去除字符串中 头和尾的空格，中间的空格保留 @Title: trim @Description: TODO
   *
   * @return String
   * @throws
   */
  ...
  public static void main(String[] args) {
    ...
    System.out.println(isNumeric("014650a"));
  }
}
